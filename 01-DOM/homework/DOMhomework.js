...
creadopor.innerHTML+= "Cristian Guzman";
...
function addToDo() {
  // Tu código acá:
  newToDo=new ToDo(document.getElementById("toDoInput").value);
...
// Tu código acá:
let clickboton= document.getElementById("addButton")
clickboton.addEventListener("click",addToDo)
